...
Plot simulations
```{r}
plotAreaCol(fName = "admin1_besag_simulation_1.png", width = 15, height = 15, estVal = admin1_besag_simulation_1, geoMap = nigeriaAdm1, leg = "", colLim = c(-3,3))
plotAreaCol(fName = "admin1_besag_simulation_2.png", width = 15, height = 15, estVal = admin1_besag_simulation_2, geoMap = nigeriaAdm1, leg = "", colLim = c(-3,3))
plotAreaCol(fName = "admin1_stdnorm_simulation_1.png", width = 15, height = 15, estVal = admin1_stdnorm_simulation_1, geoMap = nigeriaAdm1, leg = "", colLim = c(-3,3))
plotAreaCol(fName = "admin1_stdnorm_simulation_2.png", width = 15, height = 15, estVal = admin1_stdnorm_simulation_2, geoMap = nigeriaAdm1, leg = "", colLim = c(-3,3))
```
...
Plot simulations
```{r}
plotAreaCol(fName = "admin2_besag_simulation_1.png", width = 15, height = 15, estVal = admin2_besag_simulation_1, geoMap = nigeriaAdm2, leg = "", colLim = c(-3,3))
plotAreaCol(fName = "admin2_besag_simulation_2.png", width = 15, height = 15, estVal = admin2_besag_simulation_2, geoMap = nigeriaAdm2, leg = "", colLim = c(-3,3))
plotAreaCol(fName = "admin2_stdnorm_simulation_1.png", width = 15, height = 15, estVal = admin2_stdnorm_simulation_1, geoMap = nigeriaAdm2, leg = "", colLim = c(-3,3))
plotAreaCol(fName = "admin2_stdnorm_simulation_2.png", width = 15, height = 15, estVal = admin2_stdnorm_simulation_2, geoMap = nigeriaAdm2, leg = "", colLim = c(-3,3))
```
...
Plot simulations
```{r}
plotAreaCol(fName = "admin2_besag_var_simulation.png", width = 15, height = 15, estVal = admin2_besag_VC_simulation$variances, geoMap = nigeriaAdm2, leg = "var", colLim = c(0,1))
plotAreaCol(fName = "admin2_besag_corr_simulation.png", width = 15, height = 15, estVal = admin2_besag_VC_simulation$correlation, geoMap = nigeriaAdm2, leg = "corr", colLim = c(-1,1))
