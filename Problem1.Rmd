...
Plot simulations
```{r}
plotAreaCol(fName = "admin1_besag_simulation_1.jpg", estVal = admin1_besag_simulation_1, geoMap = Admin1Geography, leg = "values", colLim = c(-5,5))
plotAreaCol(fName = "admin1_besag_simulation_2.jpg", estVal = admin1_besag_simulation_2, geoMap = Admin1Geography, leg = "values", colLim = c(-5,5))
plotAreaCol(fName = "admin1_stdnorm_simulation_1.jpg", estVal = admin1_stdnorm_simulation_1, geoMap = Admin1Geography, leg = "values", colLim = c(-5,5))
plotAreaCol(fName = "admin1_stdnorm_simulation_2.jpg", estVal = admin1_stdnorm_simulation_2, geoMap = Admin1Geography, leg = "values", colLim = c(-5,5))
```
