...
plotAreaCol(fName = "admin1_cv_2e_1.jpeg", width = 15, height = 11, estVal = cv.2e_1, geoMap = nigeriaAdm1, leg = "CV", colLim = c(0,0.9))
...
plotAreaCol(fName = "admin1_cv_2e_2.jpeg", width = 15, height = 11, estVal = cv.2e_2, geoMap = nigeriaAdm1, leg = "CV", colLim = c(0,0.5))
...
plotAreaCol(fName = "admin1_cv_2e_3.jpeg", width = 15, height = 11, estVal = cv.2e_3, geoMap = nigeriaAdm1, leg = "CV", colLim = c(0,0.5))
```
